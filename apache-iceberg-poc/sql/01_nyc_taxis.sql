-- =============================================================================
-- Iceberg Flink quickstart flow (REST catalog + MinIO)
-- Based on: https://github.com/apache/iceberg/blob/main/docker/iceberg-flink-quickstart/test.sql
-- =============================================================================
-- Prerequisites:
--   docker compose up -d --build
--   docker exec -it jobmanager ./bin/sql-client.sh
-- Or: docker exec -i jobmanager ./bin/sql-client.sh < sql/01_nyc_taxis.sql
-- =============================================================================
...
-- -----------------------------------------------------------------------------
-- 6. Inspect Iceberg metadata (optional)
-- -----------------------------------------------------------------------------
-- Snapshots
...
-- -----------------------------------------------------------------------------
-- 7. Cleanup (optional; uncomment to remove objects)
-- -----------------------------------------------------------------------------

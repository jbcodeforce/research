...
This repository is strongly influenced by Simon Willison work, as I think it is cool to do code research and studies, on different subjects, independently of other repository .

Each folder includes its own research project. I will use different Agents: Pi, Claude Code, and custom ones done with Agno.
